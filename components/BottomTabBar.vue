...
const tabs = [
  ...
  { to: '/idiomslang',     label: 'Idioms',        aria: 'Idioms and Slang tab' },
  { to: '/rhythm',         label: 'Stress',        aria: 'Word Stress tab'  },
  ...
  >
    <div class="flex">
      ...
      >
        ...
        <template v-if="tab.to === '/idiomslang'">
        ...
        <!-- Word Stress: equalizer bars -->
        <template v-else-if="tab.to === '/rhythm'">
          <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24" aria-hidden="true">
            <line x1="6" y1="20" x2="6" y2="10" stroke-linecap="round" />
            <line x1="12" y1="20" x2="12" y2="4" stroke-linecap="round" />
            <line x1="18" y1="20" x2="18" y2="14" stroke-linecap="round" />
          </svg>
        </template>
