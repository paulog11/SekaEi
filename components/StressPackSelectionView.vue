...
function difficultyColor(d: StressPack['difficulty']): string {
...
<template>
  <div class="flex flex-col items-center gap-8 py-8">
    <div class="text-center">
      ...
      <p class="text-sm text-ink-light mt-1">Select a pack to start practising word stress.</p>
    </div>
        ...
        >
          ...
          <div class="absolute inset-x-0 bottom-0 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-b-2xl">
            ...
            <div class="flex items-center justify-between mt-1">
              <span class="text-[10px] text-ink-light">{{ pack.challenges.length }} words</span>
